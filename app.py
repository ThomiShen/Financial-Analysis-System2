...
import PyPDF2
from timian  import BigTimian_20,BigTimian_5, DataFetcher
...
def search():
    ...
    return render_template('search.html',round=round,query=query,score_20=s_score_20,score_5=s_score_5)
